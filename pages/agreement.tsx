...
const Agreement = () => {
  return (
    <>
      ...
      <Head>
        <title>Terms and Conditions | Funds</title>
      </Head>
      <Paper
        withBorder
        sx={{ padding: 20, borderRadius: 30, marginBottom: 20, marginTop: 15 }}
      >
        <h2>
          <strong>Terms and Conditions</strong>
        </h2>

        <p>Welcome to Funds!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Funds&apos;s Website, located at https://funds.kasperluna.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Funds if you do not agree to take
        ...
        <p>
          We employ the use of cookies. By accessing Funds, you agreed to use
          cookies in agreement with the Funds&apos; Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, Funds and/or its licensors own the
          intellectual property rights for all material on Funds. All
          intellectual property rights are reserved. You may access this from
          Funds for your own personal use subjected to restrictions set in these
          terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Funds</li>
          <li>Sell, rent or sub-license material from Funds</li>
          <li>Reproduce, duplicate or copy material from Funds</li>
          <li>Redistribute content from Funds</li>
        </ul>
        ...
        <p>
          ...
          Funds does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of Funds,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, Funds shall not be liable for
        ...
        <p>
          Funds reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Funds a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          the hyperlink compensates the absence of Funds; and (d) the link is in
        ...
        <p>
          ...
          sending an e-mail to Funds. Please include your name, your
        ...
        <p>
          No use of Funds&apos;s logo or other artwork will be allowed for
        ...
        <p>
          Please read <a href="#Privacy_Policy">Privacy Policy</a>
        </p>
      ...
      <Paper
        id="Privacy_Policy"
        withBorder
        sx={{ padding: 20, borderRadius: 30 }}
      >
        <h1>Privacy Policy of Funds</h1>

        <p>
          Funds operates the https://funds.kasperluna.com website, which
        ...
        <p>
          ...
          anyone decided to use our Service, the Funds website.
        </p>
        ...
        <p>
          ...
          https://funds.kasperluna.com, unless otherwise defined in this Privacy
          Policy.
        </p>
        ...
        <p>
          ...
          but not limited to your name and email address. The information that
