    ...
    <div className="flex min-h-screen flex-col bg-black text-white">
      ...
      <main className="flex-1">
        <div className="max-w-2xl mx-auto py-16 px-4">
          ...
          <p className="mb-4">
            Funds is committed to protecting your privacy. This Privacy Policy
          ...
          <ul className="list-disc ml-6 mb-4">
            <li>
              Account information (such as email address) when you sign up.
            </li>
            <li>
              Financial data you manually enter (income, expenses, categories).
            </li>
          </ul>
          <h2 className="text-xl font-semibold mt-8 mb-2">
          ...
          <ul className="list-disc ml-6 mb-4">
            <li>To provide and maintain the Funds service.</li>
          ...
          <p className="mb-4">
            ...
            including encryption in transit and at rest. Your data is never
          ...
          <p className="mb-4">
            ...
            to provide our services. You can request deletion of your account
