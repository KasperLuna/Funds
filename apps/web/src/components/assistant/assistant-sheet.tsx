  ...
  return (
    <DialogRoot open onOpenChange={(o) => !o && onClose()}>
      <DialogPortal>
        ...
        <div
          className="fixed inset-x-0 z-50 flex min-h-0 flex-col overflow-hidden border border-b-0 border-(--border-strong) bg-(--bg) data-[state=open]:animate-[funds-sheet-in_250ms_cubic-bezier(0.32,0.72,0,1)] sm:left-1/2 sm:right-auto sm:top-1/2 sm:max-h-[85vh] sm:w-full sm:max-w-md sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-(--radius-lg) sm:border-b"
          style={{
